...
class JApplicationDaemon extends JApplicationCli
{
	 ...
	 * @param   JRegistry         $config      An optional argument to provide dependency injection for the application's
	 ...
	 *                                         event dispatcher.  If the argument is a JEventDispatcher object that object will
	 *                                         become the application's event dispatcher, if it is null then the default event
	 *                                         dispatcher will be created based on the application's loadDispatcher() method.
	 *
	 * @since   11.1
